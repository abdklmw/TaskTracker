...
gulp.task('js', () => {
    return gulp.src(['wwwroot/js/site.js', 'wwwroot/js/user-preferences.js', 'wwwroot/js/clock-animation.js', 'wwwroot/js/invoice-creation.js', 'wwwroot/js/filters.js', 'wwwroot/js/expenses.js', 'wwwroot/js/timeentries.js'])
